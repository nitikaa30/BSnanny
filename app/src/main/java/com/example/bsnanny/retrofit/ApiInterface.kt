...
interface ApiInterface {
    ...
    @POST("feedback/save")
    suspend fun saveFeedback( @Header("Authorization") token:String,@Body feedback: Feedback):Response<FeedbackResponse>

    @GET("feedback/list_feedbacks")
    suspend fun getFeedbackList(@Header("Authorization") token:String):Response<FeedbackListResponse>
}