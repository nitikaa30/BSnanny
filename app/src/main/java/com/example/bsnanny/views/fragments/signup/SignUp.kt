package com.example.bsnanny.views.fragments.signup
        ...
        binding.AuthSignUpBtn.setOnClickListener {
            ...
            when {
                ...
                binding.SignUpPhoneNum.text.toString().length < 10 -> {
                    ...
                    binding.signupCard.strokeColor = R.color.purpleU1
                    val type = "SignUp"
                    val countryCode = binding.SignUpCountryCode.selectedCountryCode
                    val phoneNum = "+" + binding.SignUpCountryCode.selectedCountryCode + binding.SignUpPhoneNum.text.toString()
                    val action = SignUpDirections.actionSignUpToOtp(phoneNum , countryCode, type)
